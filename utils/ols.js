...
const URI_V = URI_base + 'api.php/v3/'    //接口地址
...
function loginOrGetRegisterPassword(params) {
  return fetch.olsfetchpost(URI_V, 'login/getpassword', params, '获取注册用的口令 /登录')
}
// 通过注册口令 注册
function registerWithPassword(params) {
  return fetch.olsfetchpost(URI_V, 'login/getphonelogin', params, '通过注册口令 注册', true, '登录中')
}
// 首页年级选择
function getlist(params) {
  return fetch.olsfetchpost(URI_V, 'grade/getlist', params,"获取年级")
}
//获取平台人数
function user_number(params) {
  return fetch.olsfetchpost(URI_V, 'basic/getmembernum', params,'平台人数')
}
// 获取学科
...
function hot_list4(params) {
  return fetch.olsfetchpost(URI_V, 'lesson/gethotlist', params,"热门课程",false,"课程加载中...")
}
// 获取广告弹窗数据
function getAdWindow(params) {
  return fetch.olsfetchpost(URI_V, 'activity/getlist', params, '获取广告弹窗数据')
}
//轮播图
...
function grade_course4(params) {
  return fetch.olsfetchpost(URI_V, 'lesson/getlist', params)
}
//会员列表
function v4_viplist(params) {
  return fetch.olsfetchpost(URI_V, 'vipcard/getlist', params,"会员卡列表")
}
// 我的课程
function my_course_all4(params) {
  return fetch.olsfetchpost(URI_V, 'order/getLessonlist', params,"我的课程")
}
// 刷新用户基本信息
function my_about(params) {
  return fetch.olsfetchpost(URI_V, 'basic/aboutus', params, '关于我们')
}
//获取课程视频链接
...
function video_start(params) {
  return fetch.olsfetchpost(URI_V, 'study/setbeginvideoline', params,"视频开始更新状态")
}
//视频结束更新状态——1.2
function video_end(params) {
  return fetch.olsfetchpost(URI_V, 'study/setfinishvideoline', params,"视频结束更新状态")
}
//分享判断
function judge_share4(params) {
  return fetch.olsfetchpost(URI_V, 'share/getinterface', params,"分享判断v4",true,"分享加载中")
}
//更新年级
function grade_update(params) {
  return fetch.olsfetchpost(URI_V, 'member/update', params,"更新年级")
}
//课程直播/伪直播链接获取
function get_live(params) {
  return fetch.olsfetchpost(URI_V, 'lesson/getmtcourseurl', params,"欢拓直播/伪直播")
}
//优惠券开启状态
...
function essayDetail(params) {
  return fetch.olsfetchpost(URI_V, 'news/getinfo', params,"广告条文章详情")
}
//后台推荐课程（关联后台推荐按钮）
...
function v4_myVip(params) {
  return fetch.olsfetchpost(URI_V, 'vipcard/getvipcard', params,"我的vip")
}
function cardInfo(params) {
  return fetch.olsfetchpost(URI_V, 'vipcard/getviplist', params,"课程页会员卡列表")
}
function couponTea(params) {
  return fetch.olsfetchpost(URI_V, 'basic/getteacherinfo', params,"优惠券老师")
}
//会员卡权益
...
function course_cata(params) {
  return fetch.olsfetchpost(URI_V, 'lesson/getoption', params)
}
// 权益包展示数据
...
function clickSign(params) {
  return fetch.olsfetchpost(URI_V, 'lesson_spread/setlessonspread', params,"课程详情点击报名按钮次数记录")
}
//课程详情报名成功记录
function succeedSign(params) {
  return fetch.olsfetchpost(URI_V, 'lesson_spread/signlessonspread', params,"课程详情报名成功记录")
}
// 获取全部订单(拼团)
...
function course_info2(params) {
  return fetch.olsfetchpost(URI_V, 'lesson/getinfo', params)
}
...
function group_detail3(params) {
  return fetch.olsfetchpost(URI_V, 'group/getgrouplist', params)
}
//团分享v3
...
function all_group3(params) {
  return fetch.olsfetchpost(URI_V, 'group/getlessongrouplist', params,"团分享")
}
